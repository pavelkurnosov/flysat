(function () {
    ...
    function InputCtrl($http, $uibModal, ServerURL) {
        ...
        vm.tabs = [
            ...
            {"id": "info_page", "heading": "Info Pages", "active": false, "template": "app/main/views/tabs/infopages.html"}
        ];
        ...
        vm.getData = function () {
            $http.get(ServerURL + vm.currTab + "-get")
...
function DataformCtrl($scope, parentScope, currRowId) {
